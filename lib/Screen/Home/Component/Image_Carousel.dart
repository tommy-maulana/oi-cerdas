...
final List<Carouselmodel> imgList = [
  new Carouselmodel(
      ...
      onpress: () {
        launchURL("https://www.oganilirkab.go.id/");
      }),
  new Carouselmodel(
      imgpath: 'assets/images/CLBK-OVO.jpg',
      onpress: () {
        launchURL("https://www.oganilirkab.go.id/news");
      }),
  new Carouselmodel(
      imgpath: 'assets/images/bayardisini.jpg',
      onpress: () {
        launchURL("https://www.oganilirkab.go.id/page/peraturan-kepegawaian");
      }),
  new Carouselmodel(
      imgpath: 'assets/images/sos.jpg',
      onpress: () {
        launchURL(
            "https://www.oganilirkab.go.id/page/anggaran-pendapatan-dan-belanja-daerah-kabupaten-ogan-ilir-tahun-anggaran-2020");
      }),
  new Carouselmodel(
      imgpath: 'assets/images/double.jpg',
      onpress: () {
        launchURL("https://www.oganilirkab.go.id/video");
      }),
];
