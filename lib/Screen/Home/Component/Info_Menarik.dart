    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          SizedBox(height: 6),
          Text(
            "Jangan ngaku update kalau belum kunjungi Ogan Ilir",
          ...
          Row(
            ...
            children: <Widget>[
              InfoCard(
                ...
                title: "Pusat Bantuan",
                desc:
                    "Punya kendala atau pertanyaan mengenai Ogan Ilir? kamu bisa kirim disini",
                textbutton: "Lihat Bantuan",
                onpress: () {},
              ),
              InfoCard(
                imgpath: "assets/images/27053.jpg",
                title: "OI Lawan COVID-19",
                desc:
                    "Segera Daftar Vaksinasi agar terbebas dari Virus COVID-19",
